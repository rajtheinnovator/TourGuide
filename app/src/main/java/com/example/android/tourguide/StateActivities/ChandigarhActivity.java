...
public class ChandigarhActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cities.add(new StatesAndCity(getResources().getString(R.string.chandigarh_name), R.drawable.chandigarh, R.id.chandigarh));

        CityListAdapter stateListAdapter = new CityListAdapter(ChandigarhActivity.this, cities);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                switch (state.getmStateOrCityresourceId()) {
                    case R.id.chandigarh:
                        Intent chandigarhIntent = new Intent(ChandigarhActivity.this, CityDetailsActivity.class);
                        ...
                        cityDetail.add(new CityDetails(getResources().getString(R.string.chandigarh_name),
                                getResources().getString(R.string.chandigarh_information), R.drawable.bihar_info));

                        //City hotels information here
                        cityHotels.add(new CityDetails(getResources().getString(R.string.chandigarh_hotel1information),
                                getResources().getString(R.string.chandigarh_hotel2information), R.drawable.bihar_info, R.drawable.bihar_info));

                        //City how to reach there/commute information here
                        cityReachBy.add(new CityDetails(getResources().getString(R.string.chandigarh_reach_by_train),
                                getResources().getString(R.string.chandigarh_reach_by_bus),
                                (getResources().getString(R.string.chandigarh_reach_by_flight)), R.drawable.bihar_info));

                        //City places to visit information here
                        cityMustVisit.add(new CityDetails(getResources().getString(R.string.chandigarh_mustVisit_place1Information),
                                getResources().getString(R.string.chandigarh_mustVisit_place2Information),
                                (getResources().getString(R.string.chandigarh_mustVisit_place3Information)),
                        ...
                        chandigarhIntent.putParcelableArrayListExtra("cityDetail", cityDetail);
                        chandigarhIntent.putParcelableArrayListExtra("cityHotels", cityHotels);
                        chandigarhIntent.putParcelableArrayListExtra("cityReachBy", cityReachBy);
                        chandigarhIntent.putParcelableArrayListExtra("cityMustVisit", cityMustVisit);
