        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                switch (state.getmStateOrCityresourceId()) {
                    case R.id.gurgaon:
                        Intent gurgaonIntent = new Intent(HaryanaActivity.this,GurgaonCityDetailsActivity.class);
                        startActivity(gurgaonIntent);
                        break;
                    case R.id.karnal:
                        Intent karnalIntent = new Intent(HaryanaActivity.this, KarnalCityDetailsActivity.class);
                        startActivity(karnalIntent);
                        break;
                    case R.id.kurukshetra:
                        Intent kurukshetraIntent = new Intent(HaryanaActivity.this, KurukshetraCityDetailsActivity.class);
                        startActivity(kurukshetraIntent);
                        break;
                    case R.id.panipat:
                        Intent panipatIntent = new Intent(HaryanaActivity.this, PanipatCityDetailsActivity.class);
                        startActivity(panipatIntent);
                        break;
                    case R.id.hisar:
                        Intent hisarIntent = new Intent(HaryanaActivity.this, HisarCityDetailsActivity.class);
